---
title: "BIOS 621 / 821 sessions 2-3 lab exercises"
author: "Levi Waldron"
output:
  html_notebook: 
    toc: yes
...
# Lab Exercises - contraceptive use data

Learning objectives:
* gain additional familiarity with R, including `dplyr` and `ggplot2`
...
# Loading the contraceptive use data
...
for moving into another pubication or presentation document. See the [tableone vignette](https://cran.r-project.org/web/packages/tableone/vignettes/introduction.html) for more complex usage.
...
```{r}
library(ggplot2)
ggplot(cuse, aes(x=age, y=I(using+notUsing), fill=notUsing)) + 
