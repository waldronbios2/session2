...
subtitle: "Linear and Logistic Regression as Generalized Linear Models"
author: "Levi Waldron"
institute: "CUNY SPH"
output:
  beamer_presentation:
...
cuse <- mutate(cuse, percentusing = using / (using + notUsing) * 100) %>%
...
tableone::CreateTableOne(
  data = cuse,
  vars = c("education", "wantsMore", "percentusing"),
  strata = "age",
  addOverall = TRUE,
  test = FALSE
)
...
See [tableone](https://cran.r-project.org/web/packages/tableone/vignettes/introduction.html) vignette for e.g. how to export to Word / Excel
